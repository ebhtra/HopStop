...
private let SQLITE_FILENAME = "HopStop.sqlite"
private let ERROR_DOMAIN = "HopStopIssues"
...
class CoreDataStackManager {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("HopStop", withExtension: "momd")!
    ...
    lazy var tempContext: NSManagedObjectContext = {
        // This will be used as a holding area for objects before they are potentially passed and saved to the managedObjectContext
